...
- Confirm you're on the 192.168.4.x subnet
...
| What | How |
|---|---|
| Server IP | `192.168.4.31` |
| SIP Port | `5060/UDP` |
| Extensions | `1001` / `1002` / `1003` |
| Passwords | `test1001` / `test1002` / `test1003` |
| AI Number | **9999** |
| Dashboard | `http://192.168.4.31:3000` |
| Agent API | `http://192.168.4.31:8000` |
